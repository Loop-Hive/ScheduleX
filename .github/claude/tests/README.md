...
This directory contains comprehensive tests generated by Claude AI for the ScheduleX project.
The tests are designed to provide good coverage and catch real bugs in your application.

## 🧪 Generated Test Files

- `Calendar.test.tsx` - Application tests
- `TagColorPicker.test.tsx` - Application tests
- `TimePicker.test.tsx` - Application tests
- `functions.test.ts` - Application tests
- `csv-export.test.ts` - Application tests
- `message-box.test.tsx` - Application tests
- `MessageOverlay.test.tsx` - Application tests
- `Card1.test.tsx` - Application tests
