...
const ManageScheduleScreen: React.FC<ManageScheduleScreenProps> = ({navigation}) => {
  ...
  const daysOfWeek = getOrderedDays();  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={[styles.titleSection, {flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap'}]}>
